...
function getConexao($Caminho = 'sqlite:db/database.sqlite3'){
...
function getConexaoVenda($Caminho = 'sqlite:../db/database.sqlite3'){
    return getConexao($Caminho);
}
